...
- Responsive: Lịch sử toàn bộ trên mobile/tablet (<768px) hiển thị dạng thẻ có đầy đủ thông tin (tên sản phẩm, tên biến thể, tồn trước/sau, số lượng, ghi chú, thời gian chính xác đến giây theo múi giờ +7 Việt Nam) mà không cần cuộn ngang. Desktop (≥768px) giữ bảng truyền thống.
...
- **FR-006**: Danh sách sản phẩm trên mobile/tablet (viewport <1025px) PHẢI hiển thị dạng thẻ (card) thay vì bảng, để người dùng thấy ngay tồn kho và các nút thao tác mà không cần cuộn ngang. Desktop (≥1025px) giữ bảng truyền thống.
- **FR-007**: Dialog điều chỉnh tồn kho PHẢI hiển thị hai nút "Nhập kho" / "Xuất kho" trực quan thay vì dropdown chọn loại, giúp người dùng trung niên thao tác nhanh hơn.
